...
import { NATIONS, LEAGUES, ALL_POSITIONS, clubById, leagueById, homeLeagueOf, weakestClubInLeague, ROLE_GROUP, generatePlayerName, generateSquadNumber, NATION_LEGACY_MULT, isWcAge, isNatContAge, isOlympicAge, SIGNATURE_ELITE, signatureStatOf, type Position, type RoleGroup } from "./engine/data";
...
import { careerUrl, parseCareerUrl, VALID_PACE, type CareerLink } from "./ui/share-link";
...
// careerUrl / parseCareerUrl / CareerLink / VALID_PACE live in ./ui/share-link now.
